...
//         if( err){
//             console.log("Error in inserting user derail")
...
//         "Password":passw,
//     }
//     var user = await cl.findOne({"Username ": uname});
...
//     try {
//          cl.updateOne({"Username":uname}, {$set:{"Username":newuname}},(err)=>{
//             if(err){
//                 res.send('Similer!')
//             };
//             res.send('Done')
...
// app.listen(8056,(err)=>{
//     if(err) throw err;
//     console.log('Server starat on http://localhost:8056/')
// })
